...
type grpcServer struct {
	...
	serviceStatus grpcServer.Handler
}
...
func (g *grpcServer) ServiceStatus(ctx context.Context, r *watermark.ServiceStatusRequest) (*watermark.StatusReply, error) {
	_, rep, err := g.get.ServeGRPC(ctx, r)
	if err != nil {
		return nil, err
	}
...
func (g *grpcServer) Watermark(ctx context.Context, r *watermark.WaterRequest) (*watermark.WatermarkReply, error) {
...
func decodeGRPCGetRequest(_ context.Context, grpcReq interface{}) (interface{}, error) {
	...
	for _, f := range req.Filters {
		filters = append(filters, internal.Filter{Key: f.Key, f.Value})
	}
...
func decodeGRPCWaterResponse(ctx context.Context, grpcReply interface{}) (interface{}, error) {
